...
function ge() {
  ...
  if (o.version = "2.5.7", o.removed = [], !n || !n.document || n.document.nodeType !== 9)
  ...
  }, Jt = i({}, ["mi", "mo", "mn", "ms", "mtext"]), Qt = i({}, ["annotation-xml"]), Fe = i({}, ["title", "style", "font", "a", "script"]), nt = i({}, Lt);
  i(nt, Ct), i(nt, Qe);
  var kt = i({}, Rt);
  i(kt, tn);
  var Ue = function(t) {
      ...
      for (s = N.length; s--; ) {
        ...
        if (e = x === "value" ? r.value : Ze(r.value), c = h(x), m.attrName = c, m.attrValue = e, m.keepAttr = !0, m.forceKeepAttr = void 0, L("uponSanitizeAttribute", t, m), e = m.attrValue, !m.forceKeepAttr && (rt(x, t), !!m.keepAttr)) {
          ...
          if (oe(le, c, e)) {
            ...
            if (S && D(V) === "object" && typeof V.getAttributeType == "function" && !T)
