import { b as Zt, X as ko, e as wn } from "./index.package-vrfw5wYK.js";
var ce = function(i) {
...
}, Do = vr, jo = Function.prototype, Hi = jo.call, Ph = Do && jo.bind.bind(Hi, Hi), j = Do ? Ph : function(i) {
  return function() {
...
}, Fh = j, xr = Fh({}.isPrototypeOf), Xh = _, pa = Xh.navigator, da = pa && pa.userAgent, Ce = da ? String(da) : "", zo = _, Kr = Ce, ma = zo.process, ya = zo.Deno, va = ma && ma.versions || ya && ya.version, xa = va && va.v8, ut, gr;
xa && (ut = xa.split("."), gr = ut[0] > 0 && ut[0] < 4 ? 1 : +(ut[0] + ut[1]));
!gr && Kr && (ut = Kr.match(/Edge\/(\d+)/), (!ut || ut[1] >= 74) && (ut = Kr.match(/Chrome\/(\d+)/), ut && (gr = +ut[1])));
var Tn = gr, ba = Tn, Hh = D, Yh = _, Wh = Yh.String, Fo = !!Object.getOwnPropertySymbols && !Hh(function() {
  ...
  !Symbol.sham && ba && ba < 41;
}), qh = Fo, Xo = qh && !Symbol.sham && typeof Symbol.iterator == "symbol", Gh = zt, Qh = B, $h = xr, Zh = Xo, Jh = Object, Ho = Zh ? function(i) {
...
}, Yo = { exports: {} }, wa = _, ol = Object.defineProperty, On = function(i, t) {
  try {
    ol(wa, i, { value: t, configurable: !0, writable: !0 });
  } catch {
    wa[i] = t;
  }
  return t;
}, ul = _, hl = On, Sa = "__core-js_shared__", Ta = Yo.exports = ul[Sa] || hl(Sa, {});
(Ta.versions || (Ta.versions = [])).push({
  version: "3.39.0",
  mode: "global",
...
var An = Yo.exports, Oa = An, En = function(i, t) {
  return Oa[i] || (Oa[i] = t || {});
...
}, xl = _, bl = En, Aa = gt, wl = Wo, Sl = Fo, Tl = Xo, Jt = xl.Symbol, ii = bl("wks"), Ol = Tl ? Jt.for || Jt : Jt && Jt.withoutSetter || wl, H = function(i) {
  return Aa(ii, i) || (ii[i] = Sl && Aa(Jt, i) ? Jt[i] : Ol("Symbol." + i)), ii[i];
}, Al = W, Ea = ct, Ca = Ho, El = oe, Cl = sl, Pl = H, Nl = TypeError, Ml = Pl("toPrimitive"), Rl = function(i, t) {
  if (!Ea(i) || Ca(i)) return i;
  var e = El(i, Ml), r;
  if (e) {
    if (t === void 0 && (t = "default"), r = Al(e, i, t), !Ea(r) || Ca(r)) return r;
    throw new Nl("Can't convert object to primitive value");
  }
  return t === void 0 && (t = "number"), Cl(i, t);
}, Vl = Rl, kl = Ho, qo = function(i) {
  var t = Vl(i, "string");
  return kl(t) ? t : t + "";
}, Il = _, Pa = ct, Yi = Il.document, _l = Pa(Yi) && Pa(Yi.createElement), Sr = function(i) {
...
}), Bl = ht, Ul = W, zl = Io, Fl = Sn, Xl = Ee, Hl = qo, Yl = gt, Wl = Go, Na = Object.getOwnPropertyDescriptor;
Ae.f = Bl ? Na : function(i, t) {
  if (i = Xl(i), t = Hl(t), Wl) try {
    return Na(i, t);
  } catch {
  }
...
}, Jl = ht, Kl = Go, tc = Qo, Xe = K, Ma = qo, ec = TypeError, ni = Object.defineProperty, rc = Object.getOwnPropertyDescriptor, ai = "enumerable", si = "configurable", oi = "writable";
St.f = Jl ? tc ? function(i, t, e) {
  if (Xe(i), t = Ma(t), Xe(e), typeof i == "function" && t === "prototype" && "value" in e && oi in e && !e[oi]) {
    var r = rc(i, t);
...
var Pn = qi.inspectSource, fc = _, pc = B, Ra = fc.WeakMap, dc = pc(Ra) && /native code/.test(String(Ra)), mc = En, yc = Wo, Va = mc("keys"), Nn = function(i) {
  return Va[i] || (Va[i] = yc(i));
}, Mn = {}, vc = dc, Jo = _, xc = ct, bc = Pe, ui = gt, hi = An, wc = Nn, Sc = Mn, ka = "Object already initialized", Gi = Jo.TypeError, Tc = Jo.WeakMap, fr, Se, pr, Oc = function(i) {
...
var Or = {
  ...
  enforce: Oc,
  getterFor: Ac
}, Rn = j, Ec = D, Cc = B, He = gt, Qi = ht, Pc = Tr.CONFIGURABLE, Nc = Pn, Ko = Or, Mc = Ko.enforce, Rc = Ko.get, Ia = String, sr = Object.defineProperty, Vc = Rn("".slice), kc = Rn("".replace), Ic = Rn([].join), _c = Qi && !Ec(function() {
  return sr(function() {
  }, "length", { value: 8 }).length !== 8;
}), Lc = String(String).split("String"), Dc = $o.exports = function(i, t, e) {
  Vc(Ia(t), 0, 7) === "Symbol(" && (t = "[" + kc(Ia(t), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), e && e.getter && (t = "get " + t), e && e.setter && (t = "set " + t), (!He(i, "name") || Pc && i.name !== t) && (Qi ? sr(i, "name", { value: t, configurable: !0 }) : i.name = t), _c && e && He(e, "arity") && i.length !== e.arity && sr(i, "length", { value: e.arity });
  try {
    e && He(e, "constructor") && e.constructor ? Qi && sr(i, "prototype", { writable: !1 }) : i.prototype && (i.prototype = void 0);
  } catch {
  }
  var r = Mc(i);
  return He(r, "source") || (r.source = Ic(Lc, typeof t == "string" ? t : "")), i;
};
...
var tu = $o.exports, jc = B, Bc = St, Uc = tu, zc = On, Ft = function(i, t, e, r) {
  ...
  return i;
}, eu = {}, Fc = Math.ceil, Xc = Math.floor, Hc = Math.trunc || function(i) {
  var t = +i;
  return (t > 0 ? Xc : Fc)(t);
}, Yc = Hc, Ar = function(i) {
  var t = +i;
  ...
  return Jc(i.length);
}, Kc = Ee, tg = Qc, eg = Vn, _a = function(i) {
  ...
  indexOf: _a(!1)
}, rg = j, li = gt, ig = Ee, ng = ru.indexOf, ag = Mn, La = rg([].push), iu = function(i, t) {
  var e = ig(i), r = 0, n = [], a;
  for (a in e) !li(ag, a) && li(e, a) && La(n, a);
  for (; t.length > r; ) li(e, a = t[r++]) && (~ng(n, a) || La(n, a));
  return n;
}, kn = [
  "constructor",
  "hasOwnProperty",
...
var hg = zt, lg = j, cg = eu, gg = nu, fg = K, pg = lg([].concat), dg = hg("Reflect", "ownKeys") || function(i) {
  ...
  return e ? pg(t, e(i)) : t;
}, Da = gt, mg = dg, yg = Ae, vg = St, xg = function(i, t, e) {
  for (var r = mg(t), n = vg.f, a = yg.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !Da(i, s) && !(e && Da(e, s)) && n(i, s, a(t, s));
  }
  ...
  return Bg(i) || i === null;
}, zg = Ug, Fg = String, Xg = TypeError, Hg = function(i) {
  if (zg(i)) return i;
  throw new Xg("Can't set " + Fg(i) + " as a prototype");
}, Yg = jg, Wg = ct, qg = lt, Gg = Hg, ou = Object.setPrototypeOf || ("__proto__" in {} ? function() {
  var i = !1, t = {}, e;
  try {
...
}() : void 0), Qg = St.f, $g = gt, Zg = H, ja = Zg("toStringTag"), Cr = function(i, t, e) {
  i && !e && (i = i.prototype), i && !$g(i, ja) && Qg(i, ja, { configurable: !0, value: t });
}, Ba = tu, Jg = St, Kg = function(i, t, e) {
  return e.get && Ba(e.get, t, { getter: !0 }), e.set && Ba(e.set, t, { setter: !0 }), Jg.f(i, t, e);
}, tf = zt, ef = Kg, rf = H, nf = ht, Ua = rf("species"), af = function(i) {
  var t = tf(i);
  nf && t && !t[Ua] && ef(t, Ua, {
    configurable: !0,
    get: function() {
...
}, hf = H, lf = hf("toStringTag"), uu = {};
uu[lf] = "z";
var cf = String(uu) === "[object z]", gf = cf, ff = B, or = Bt, pf = H, df = pf("toStringTag"), mf = Object, yf = or(/* @__PURE__ */ function() {
  return arguments;
...
}, za = K, Rf = Mf, Vf = Ut, kf = H, If = kf("species"), fu = function(i, t) {
  var e = za(i).constructor, r;
  return e === void 0 || Vf(r = za(e)[If]) ? t : Rf(r);
}, _f = vr, pu = Function.prototype, Fa = pu.apply, Xa = pu.call, du = typeof Reflect == "object" && Reflect.apply || (_f ? Xa.bind(Fa) : function() {
  return Xa.apply(Fa, arguments);
}), Lf = Bt, Df = j, Pr = function(i) {
  if (Lf(i) === "Function") return Df(i);
}, Ha = Pr, jf = wt, Bf = vr, Uf = Ha(Ha.bind), Ln = function(i, t) {
  return jf(i), t === void 0 ? i : Bf ? Uf(i, t) : function() {
    return i.apply(t, arguments);
  };
}, zf = zt, mu = zf("document", "documentElement"), Ff = j, Xf = Ff([].slice), Hf = TypeError, Yf = function(i, t) {
  if (i < t) throw new Hf("Not enough arguments");
  return i;
}, Wf = Ce, yu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Wf), it = _, qf = du, Gf = Ln, Ya = B, Qf = gt, vu = D, Wa = mu, $f = Xf, qa = Sr, Zf = Yf, Jf = yu, Kf = Er, $i = it.setImmediate, Zi = it.clearImmediate, tp = it.process, ci = it.Dispatch, ep = it.Function, Ga = it.MessageChannel, rp = it.String, gi = 0, be = {}, Qa = "onreadystatechange", Te, Vt, fi, pi;
vu(function() {
  Te = it.location;
});
var Dn = function(i) {
...
(!$i || !Zi) && ($i = function(i) {
  ...
  var t = Ya(i) ? i : ep(i), e = $f(arguments, 1);
  ...
  ci.now(di(i));
} : Ga && !Jf ? (fi = new Ga(), pi = fi.port2, fi.port1.onmessage = $a, Vt = Gf(pi.postMessage, pi)) : it.addEventListener && Ya(it.postMessage) && !it.importScripts && Te && Te.protocol !== "file:" && !vu(Za) ? (Vt = Za, it.addEventListener("message", $a, !1)) : Qa in qa("script") ? Vt = function(i) {
  Wa.appendChild(qa("script"))[Qa] = function() {
    Wa.removeChild(this), Dn(i);
  };
} : Vt = function(i) {
  setTimeout(di(i), 0);
});
var xu = {
  set: $i,
  clear: Zi
}, Ja = _, ip = ht, np = Object.getOwnPropertyDescriptor, ap = function(i) {
  if (!ip) return Ja[i];
  var t = np(Ja, i);
  return t && t.value;
}, bu = function() {
...
var wu = bu, sp = Ce, op = /ipad|iphone|ipod/i.test(sp) && typeof Pebble < "u", up = Ce, hp = /web0s(?!.*chrome)/i.test(up), ne = _, lp = ap, Ka = Ln, mi = xu.set, cp = wu, gp = yu, fp = op, pp = hp, yi = Er, ts = ne.MutationObserver || ne.WebKitMutationObserver, es = ne.document, rs = ne.process, qe = ne.Promise, Ji = lp("queueMicrotask"), qt, vi, xi, Ge, is;
if (!Ji) {
  var Qe = new cp(), $e = function() {
    var i, t;
    for (yi && (i = rs.domain) && i.exit(); t = Qe.get(); ) try {
      t();
    } catch (e) {
      throw Qe.head && qt(), e;
    }
  ...
  !gp && !yi && !pp && ts && es ? (vi = !0, xi = es.createTextNode(""), new ts($e).observe(xi, { characterData: !0 }), qt = function() {
    xi.data = vi = !vi;
  }) : !fp && qe && qe.resolve ? (Ge = qe.resolve(void 0), Ge.constructor = qe, is = Ka(Ge.then, Ge), qt = function() {
    is($e);
  }) : yi ? qt = function() {
    rs.nextTick($e);
  } : (mi = Ka(mi, ne), qt = function() {
    mi($e);
  }), Ji = function(i) {
    Qe.head || qt(), Qe.add(i);
  };
...
}, yp = _, Nr = yp.Promise, vp = _, we = Nr, xp = B, bp = au, wp = Pn, Sp = H, ns = su, bi = Tn;
we && we.prototype;
...
var Cp = tt, dr = Er, Et = _, ae = W, ss = Ft, os = ou, Pp = Cr, Np = af, Mp = wt, ur = B, Rp = ct, Vp = uf, kp = fu, Tu = xu.set, Bn = dp, Ip = mp, _p = jn, Lp = wu, Ou = Or, mr = Nr, Un = Me, Au = he, Mr = "Promise", Eu = Un.CONSTRUCTOR, Dp = Un.REJECTION_EVENT, jp = Un.SUBCLASSING, wi = Ou.getterFor(Mr), Bp = Ou.set, $t = mr && mr.prototype, Lt = mr, Ze = $t, Cu = Et.TypeError, tn = Et.document, zn = Et.process, en = Au.f, Up = en, zp = !!(tn && tn.createEvent && Et.dispatchEvent), Pu = "unhandledrejection", Fp = "rejectionhandled", us = 0, Nu = 1, Xp = 2, Fn = 1, Mu = 2, Je, hs, Hp, ls, Ru = function(i) {
  ...
  ae(Tu, Et, function() {
    var t = i.facade, e = i.value, r = cs(i), n;
    if (r && (n = _p(function() {
      dr ? zn.emit("unhandledRejection", e, t) : Iu(Pu, t, e);
    }), i.rejection = dr || cs(i) ? Mu : Fn, n.error))
      throw n.value;
  });
}, cs = function(i) {
  ...
  i.done || (i.done = !0, e && (i = e), i.value = t, i.state = Xp, ku(i, !0));
}, rn = function(i, t, e) {
  if (!i.done) {
    i.done = !0, e && (i = e);
    try {
...
if (Eu && (Lt = function(i) {
...
}, Je.prototype = ss(Ze, "then", function(i, t) {
  var e = wi(this), r = en(kp(this, Lt));
  return e.parent = !0, r.ok = ur(i) ? i : !0, r.fail = ur(t) && t, r.domain = dr ? zn.domain : void 0, e.state === us ? e.reactions.add(r) : Bn(function() {
    Vu(r, e);
  }), r.promise;
}), hs = function() {
  var i = new Je(), t = wi(i);
  ...
  return i === Lt || i === Hp ? new hs(i) : Up(i);
}, ur(mr) && $t !== Object.prototype)) {
  ls = $t.then, jp || ss($t, "then", function(i, t) {
    var e = this;
...
Pp(Lt, Mr, !1);
Np(Mr);
var Re = {}, qp = H, Gp = Re, Qp = qp("iterator"), $p = Array.prototype, Zp = function(i) {
  return i !== void 0 && (Gp.Array === i || $p[Qp] === i);
}, Jp = In, gs = oe, Kp = Ut, td = Re, ed = H, rd = ed("iterator"), _u = function(i) {
  if (!Kp(i)) return gs(i, rd) || gs(i, "@@iterator") || td[Jp(i)];
...
}, ld = W, fs = K, cd = oe, gd = function(i, t, e) {
  var r, n;
  fs(i);
  try {
    if (r = cd(i, "return"), !r) {
  ...
  if (n) throw r;
  return fs(r), e;
}, fd = Ln, pd = W, dd = K, md = br, yd = Zp, vd = Vn, ps = xr, xd = hd, bd = _u, ds = gd, wd = TypeError, hr = function(i, t) {
  this.stopped = i, this.result = t;
}, ms = hr.prototype, Lu = function(i, t, e) {
  var r = e && e.that, n = !!(e && e.AS_ENTRIES), a = !!(e && e.IS_RECORD), o = !!(e && e.IS_ITERATOR), s = !!(e && e.INTERRUPTED), u = fd(t, r), h, l, g, f, c, d, p, m = function(b) {
    return h && ds(h, "normal", b), new hr(!0, b);
  }, y = function(b) {
  ...
  for (d = a ? i.next : h.next; !(p = pd(d, h)).done; ) {
    ...
    if (typeof c == "object" && c && ps(ms, c)) return c;
  }
  return new hr(!1);
}, Sd = H, Du = Sd("iterator"), ju = !1;
try {
  var Td = 0, ys = {
    next: function() {
      return { done: !!Td++ };
...
var _d = tt, Ld = Me.CONSTRUCTOR, nn = Nr, Dd = zt, jd = B, Bd = Ft, vs = nn && nn.prototype;
...
if (jd(nn)) {
  var xs = Dd("Promise").prototype.catch;
  vs.catch !== xs && Bd(vs, "catch", xs, { unsafe: !0 });
}
var Ud = tt, zd = W, Fd = wt, Xd = he, Hd = jn, Yd = Lu, Wd = Bu;
Ud({ target: "Promise", stat: !0, forced: Wd }, {
  race: function(i) {
    var t = this, e = Xd.f(t), r = e.reject, n = Hd(function() {
      var a = Fd(t.resolve);
      Yd(i, function(o) {
...
}, Xn = D, om = _, Hn = om.RegExp, Yn = Xn(function() {
  var i = Hn("a", "y");
  return i.lastIndex = 2, i.exec("abcd") !== null;
}), um = Yn || Xn(function() {
  return !Hn("a", "y").sticky;
}), hm = Yn || Xn(function() {
  var i = Hn("^r", "gy");
...
var xm = K, bm = Fu, ws = kn, wm = Mn, Sm = mu, Tm = Sr, Om = Nn, Ss = ">", Ts = "<", an = "prototype", sn = "script", Xu = Om("IE_PROTO"), Si = function() {
}, Hu = function(i) {
  ...
  return i.style.display = "none", Sm.appendChild(i), i.src = String(t), e = i.contentWindow.document, e.open(), e.write(Hu("document.F=Object")), e.close(), e.F;
}, Ke, lr = function() {
  try {
...
var Wn = Object.create || function(i, t) {
  var e;
  return i !== null ? (Si[an] = xm(i), e = new Si(), Si[an] = null, e[Xu] = i) : e = lr(), t === void 0 ? e : bm.f(e, t);
...
}), te = W, Rr = j, Im = mt, _m = Uu, Lm = zu, Dm = En, jm = Wn, Bm = Or.get, Um = Nm, zm = km, Fm = Dm("native-string-replace", String.prototype.replace), yr = RegExp.prototype.exec, on = yr, Xm = Rr("".charAt), Hm = Rr("".indexOf), Ym = Rr("".replace), Ti = Rr("".slice), un = function() {
  var i = /a/, t = /b*/g;
...
Wm && (on = function(i) {
  ...
  if (c && (d = Ym(d, "y", ""), Hm(d, "g") === -1 && (d += "g"), y = Ti(r, t.lastIndex), t.lastIndex > 0 && (!t.multiline || t.multiline && Xm(r, t.lastIndex - 1) !== `
...
var Es = W, Cs = Ft, Gm = qn, Ps = D, Wu = H, Qm = Pe, $m = Wu("species"), Oi = RegExp.prototype, Gn = function(i, t, e, r) {
...
}, T0 = du, ks = W, Vr = j, O0 = Gn, A0 = D, E0 = K, C0 = B, P0 = Ut, N0 = Ar, M0 = ue, Gt = mt, R0 = lt, V0 = $n, k0 = oe, I0 = S0, _0 = Zn, L0 = H, ln = L0("replace"), D0 = Math.max, j0 = Math.min, B0 = Vr([].concat), Pi = Vr([].push), Is = Vr("".indexOf), _s = Vr("".slice), U0 = function(i) {
...
var X0 = ct, H0 = Bt, Y0 = H, W0 = Y0("match"), q0 = function(i) {
  var t;
  return X0(i) && ((t = i[W0]) !== void 0 ? !!t : H0(i) === "RegExp");
}, G0 = q0, Q0 = TypeError, Kn = function(i) {
  if (G0(i))
    throw new Q0("The method doesn't accept regular expressions");
  return i;
}, $0 = H, Z0 = $0("match"), ta = function(i) {
  var t = /./;
  try {
    "/./"[i](t);
  } catch {
...
var uy = H, hy = Wn, ly = St.f, cn = uy("unscopables"), gn = Array.prototype;
...
}, by = D, wy = B, Sy = ct, Bs = Gu, Ty = Ft, Oy = H, pn = Oy("iterator"), Qu = !1, Dt, Ni, Mi;
...
var $u = {
...
}, ky = tt, Iy = W, Zu = Tr, _y = B, Ly = Vy, Us = Gu, zs = ou, Dy = Cr, jy = Pe, Ri = Ft, By = H, Uy = Re, Ju = $u, zy = Zu.PROPER, Fy = Zu.CONFIGURABLE, Fs = Ju.IteratorPrototype, tr = Ju.BUGGY_SAFARI_ITERATORS, pe = By("iterator"), Xs = "keys", de = "values", Hs = "entries", Xy = function() {
  return this;
}, Hy = function(i, t, e, r, n, a, o) {
  Ly(e, t, r);
  var s = function(y) {
    if (y === n && f) return f;
  ...
  if (c && (d = Us(c.call(new i())), d !== Object.prototype && d.next && (Us(d) !== Fs && (zs ? zs(d, Fs) : _y(d[pe]) || Ri(d, pe, Xy)), Dy(d, u, !0))), zy && n === de && g && g.name !== de && (Fy ? jy(l, "name", de) : (h = !0, f = function() {
    return Iy(g, this);
  })), n)
    if (p = {
      values: s(de),
...
}, Wy = Ee, ea = cy, Ys = Re, Ku = Or, qy = St.f, Gy = Hy, er = Yy, Qy = ht, th = "Array Iterator", $y = Ku.set, Zy = Ku.getterFor(th), Jy = Gy(Array, "Array", function(i, t) {
  $y(this, {
    type: th,
    target: Wy(i),
    // target
...
var Ky = {
  ...
  TextTrackList: 0,
  TouchList: 0
}, tv = Sr, Vi = tv("span").classList, qs = Vi && Vi.constructor && Vi.constructor.prototype, ev = qs === Object.prototype ? void 0 : qs, Gs = _, eh = Ky, rv = ev, ye = Jy, Qs = Pe, iv = Cr, nv = H, ki = nv("iterator"), Ii = ye.values, rh = function(i, t) {
  if (i) {
    if (i[ki] !== Ii) try {
      Qs(i, ki, Ii);
    } catch {
...
var Xv = kr.exports;
const Ui = /* @__PURE__ */ ko(Xv);
var sh = `	
\v\f\r                　\u2028\u2029\uFEFF`, Hv = j, Yv = lt, Wv = mt, dn = sh, ao = Hv("".replace), qv = RegExp("^[" + dn + "]+"), Gv = RegExp("(^|[^" + dn + "])[" + dn + "]+$"), zi = function(i) {
  return function(t) {
    var e = Wv(Yv(t));
  ...
  function a(s, u, h, l, g, f) {
    return ot(s, u, h, l, g, f), n(function(c, d, p, m) {
      ...
      if (c.xRot !== void 0 && (s !== 1 || u !== 0 || h !== 0 || l !== 1)) if (S === 0) delete c.rX, delete c.rY, delete c.xRot, delete c.lArcFlag, delete c.sweepFlag, c.type = v.LINE_TO;
        ...
        var C = c.xRot * Math.PI / 180, V = Math.sin(C), I = Math.cos(C), U = 1 / O(c.rX), N = 1 / O(c.rY), q = O(I) * U + O(V) * N, G = 2 * V * I * (U - N), X = O(V) * U + O(I) * N, Q = q * l * l - G * u * l + X * u * u, Y = G * (s * l + u * h) - 2 * (q * h * l + X * s * u), $ = q * h * h - G * s * h + X * s * s, M = (Math.atan2(Y, Q - $) + Math.PI) % Math.PI / 2, k = Math.sin(M), Z = Math.cos(M);
  ...
  i.ROUND = function(s) {
    ...
    return n(function(s, u, h) {
      return v.ARC === s.type ? function(l, g, f) {
        ...
        for (var y = Math.min(l.phi1, l.phi2), b = Math.max(l.phi1, l.phi2) - y, x = Math.ceil(b / 90), w = new Array(x), A = g, O = f, S = 0; S < x; S++) {
          var C = co(l.phi1, l.phi2, S / x), V = co(l.phi1, l.phi2, (S + 1) / x), I = V - C, U = 4 / 3 * Math.tan(I * yt / 4), N = [Math.cos(C * yt) - U * Math.sin(C * yt), Math.sin(C * yt) + U * Math.cos(C * yt)], q = N[0], G = N[1], X = [Math.cos(V * yt), Math.sin(V * yt)], Q = X[0], Y = X[1], $ = [Q + U * Math.sin(V * yt), Y - U * Math.cos(V * yt)], M = $[0], k = $[1];
          w[S] = { relative: l.relative, type: v.CURVE_TO };
          var Z = function(at, pt) {
            var Tt = vn([at * l.rX, pt * l.rY], l.xRot), Ht = Tt[0], ke = Tt[1];
            return [l.cX + Ht, l.cY + ke];
          };
    ...
    var s = function(f) {
      ...
      if (p.type & v.ARC) {
        ...
        }, X = 0, Q = lo(V, -S, 0).map(G); X < Q.length; X++)
          (M = Q[X]) > N && M < q && m(go(p.cX, S, V, M));
...
function zx(i, t, e, r, n, a) {
  ...
  for (var m = null, y = null, b = 0, x = 0, w = Dx[a], A = jx[a], O = 0; O < n; O++) {
    ...
    for (var N = 0, q = 0, G = 0, X = 0, Q = l * S, Y = l * C, $ = l * V, M = l * I, k = g * S, Z = g * C, at = g * V, pt = g * I, Tt = 1; Tt < l; Tt++) {
      var Ht = x + ((u < Tt ? u : Tt) << 2), ke = o[Ht], aa = o[Ht + 1], sa = o[Ht + 2], oa = o[Ht + 3], Ie = l - Tt;
      k += (c.r = ke) * Ie, Z += (c.g = aa) * Ie, at += (c.b = sa) * Ie, pt += (c.a = oa) * Ie, N += ke, q += aa, G += sa, X += oa, c = c.next;
    }
    m = f, y = d;
    for (var jr = 0; jr < r; jr++) {
      ...
      var Pt = jr + a + 1;
      Pt = b + (Pt < u ? Pt : u) << 2, N += m.r = o[Pt], q += m.g = o[Pt + 1], G += m.b = o[Pt + 2], X += m.a = o[Pt + 3], k += N, Z += q, at += G, pt += X, m = m.next;
      var _e = y, ua = _e.r, ha = _e.g, la = _e.b, ca = _e.a;
      Q += ua, Y += ha, $ += la, M += ca, N -= ua, q -= ha, G -= la, X -= ca, y = y.next, x += 4;
    }
    b += r;
  }
  for (var Yt = 0; Yt < r; Yt++) {
    x = Yt << 2;
    var Nt = o[x], Mt = o[x + 1], Rt = o[x + 2], et = o[x + 3], zr = l * Nt, Fr = l * Mt, Xr = l * Rt, Hr = l * et, Le = g * Nt, De = g * Mt, je = g * Rt, Be = g * et;
    c = f;
    ...
    for (var Qr = 0; Qr < n; Qr++) {
      var rt = x << 2;
      o[rt + 3] = et = Be * w >>> A, et > 0 ? (et = 255 / et, o[rt] = (Le * w >>> A) * et, o[rt + 1] = (De * w >>> A) * et, o[rt + 2] = (je * w >>> A) * et) : o[rt] = o[rt + 1] = o[rt + 2] = 0, Le -= zr, De -= Fr, je -= Xr, Be -= Hr, zr -= m.r, Fr -= m.g, Xr -= m.b, Hr -= m.a, rt = Yt + ((rt = Qr + l) < h ? rt : h) * r << 2, Le += Gr += m.r = o[rt], De += Yr += m.g = o[rt + 1], je += Wr += m.b = o[rt + 2], Be += qr += m.a = o[rt + 3], m = m.next, zr += Nt = y.r, Fr += Mt = y.g, Xr += Rt = y.b, Hr += et = y.a, Gr -= Nt, Yr -= Mt, Wr -= Rt, qr -= et, y = y.next, x += r;
    }
  }
  return i;
}
...
class Ir {
  ...
  setViewBox(t) {
    ...
    if (q && r.translate(-S * U.getPixels("x"), -S * N.getPixels("y")), c) {
      var G = S * d, X = S * p;
      r.beginPath(), r.moveTo(G, X), r.lineTo(a, X), r.lineTo(a, s), r.lineTo(G, s), r.closePath(), r.clip();
    }
    if (!q) {
...
class Ct extends Xt {
  ...
  getTextFromNode(t) {
    ...
    return n === 0 && (o = Hx(o)), n === a && (o = Yx(o)), o;
  }
  renderChildren(t) {
    if (this.type !== "text") {
...
class xe {
  ...
  constructor(t, e) {
    ...
    this.parser = new Xi(r), this.screen = new Ir(t, r), this.options = r;
  ...
  static from(t, e) {
    var r = arguments;
    return bt(function* () {
      var n = r.length > 2 && r[2] !== void 0 ? r[2] : {}, a = new Xi(n), o = yield a.parse(e);
      return new xe(t, o, n);
    })();
  }
  /**
